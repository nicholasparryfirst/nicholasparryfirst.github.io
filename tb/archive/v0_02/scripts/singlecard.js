...
console.log(cardImagePath);
  ...
  let description2 = tarotCardDescriptions[shuffle + 1];


  document.getElementById("rightTextField1").innerHTML = description1;
  document.getElementById("rightTextField2").innerHTML = description2;


  //bottomContainer rendering
  let lookupButton = '<button class="dynamicButton" id="dynamicLookupButton" name="dynamicLookupButton" value="lookup" formmethod="get">Lookup this card</button>';
  ...
  document.getElementById("bottomButton3").innerHTML = yomamaButton;
